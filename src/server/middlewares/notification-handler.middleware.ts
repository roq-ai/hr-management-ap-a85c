...
const notificationMapping: Record<string, NotificationConfigInterface> = {
  'Job Posting.create': { roles: ['owner', 'administrator'], key: 'create', tenantPath: [], userPath: [] },
  'Leave Request.create': { roles: ['owner', 'hr-manager'], key: 'submit', tenantPath: [], userPath: [] },
  'Policy.update': { roles: ['owner', 'hr-manager', 'employee'], key: 'update', tenantPath: [], userPath: [] },
};
