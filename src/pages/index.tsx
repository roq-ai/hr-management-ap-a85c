  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Welcome to HR Management Application, where efficiency meets innovation. Simplifying your HR tasks, transforming your business operations."
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`Welcome to HR Management Application, where efficiency meets innovation. Simplifying your HR tasks, transforming your business operations.`}
            </Text>
            <Box
